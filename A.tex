...
\end{itemize}
In general, regulation agencies classify medical devices according to their risk factors. In US, medical devices are categorized by FDA into 3 classes, Class I, Class II and Class III, corresponding to low-risk, medium-risk and high-risk devices \cite{class}. Life-sustaining devices like implantable pacemakers are classified as Class III and in general are subject to the strictest regulations. With similar philosophy, the EU directives classifies medical devices into 5 categories. (\cite{EU_classify}) The Global Medical Device Nomenclature (GMDN) also categorize medical devices according to their applications and functions. (\figref{Cur})
\begin{figure}[t]
		\centering
