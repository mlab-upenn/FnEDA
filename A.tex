...
Human physiology Unlike open-loop medical devices, closed-loop medical devices obtain patient physiological data from sensors
\textbf{Limited Diagnostic and Therapeutic Functions}\\
One fundamental rationale behind closed-loop medical devices is to enable the patients to live their normal lives without the dependance of cumbersome medical devices and the supervision of a physician. In fact, a large number of closed-loop medical devices are implantable devices. As a result, the sensing and therapy capabilities of the devices are very limited, in order to increase portability and reduce invasiveness.  
\textbf{Heavy Reliance on Software Control}\\
The diagnostic and therapeutic functions of the devices are mostly controlled by their software components. 
