...
Due to the limited capability of medical devices, not all physiological requirements Among all the physiological requirements for a device, not all of them are equally important and sometimes it is impossible to satisfy them all. More important requirements should be given higher priorities. According to the importance of the requirement
