...
The devices are supposed to deal with all possible environment conditions. However in certain extreme conditions, not all physiological requirements can be satisfied due to the limitations of device functions. In these scenarios the device should be able to prioritize more important properties. This challenge is 
