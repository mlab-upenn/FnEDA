...
\centering
		...
		{
		\includegraphics[width=0.48\textwidth]{figs/wenckebach_book.pdf}
		\label{fig:WB_book}
		} 
		\hspace{.1in}%
		\subfigure [\small Heart model's electrograms] 
		{	
			\includegraphics[width=0.48\textwidth]{figs/WB_new.pdf} 
			\label{fig:WB}
		}
\vspace{-5pt}
\caption{(a) Electrograms of induced Wenckebach block in a patient. (b) Electrograms of induced Wenckebach block in the heart model with a basic cycle length of 420 msec}
\vspace{-15pt}
\end{figure*} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
