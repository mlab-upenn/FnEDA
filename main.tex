...
Note that this requirement focus purely on the condition of the patient, and there is no mention of the operation of the pacemaker or how the pacemaker should achieve the requirement. The corresponding specification of a single chamber pacemaker is:
