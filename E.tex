...
\textsf{$\varphi_{LRI}=$A[] (PLRI\_test.secV imply PLRI\_test.t$\leq$TLRI)}\\ we have a closed-loop system  with heart model $H_d$ (described in at the end of Chapter 2):\\ $H_4\| P\| PLRI\_test\models\varphi_{LRI}$.
